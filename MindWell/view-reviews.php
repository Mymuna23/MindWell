<?php
    ...
    function showWrittenReviews() {
        ...
        if(mysqli_num_rows($result)==0) {
            ...
            echo "<div class='table-responsive'><table class= 'table mt-5 mb-5'>
                <thead>
                    <tr>
                        <th>Counsellor</th>
    ...
    function showRelevantReviews() {
        ...
        if($_SESSION["userType"] == "helpSeeker") {
            ...
            echo "<h1 class = 'text-center mt-5 mb-4'> Received Reviews </h1>";
            showRecievedReviews();
        }
    ...
    function showAverageRatings() {
        ...
        while($row = $result->fetch_assoc()) { 
            echo "<tr>
                    <td>".$row["name"]."</td>
                    <td>".number_format($row["avgRating"], 2)."</td>
                  </tr>";
        }
    }
?>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            <a class="dropdown-item active" href="/MindWell/view-reviews.php">View Reviews</a>
